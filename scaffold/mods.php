...
/*!
2015-01-14
给 modCard 增加了 type 参数，用来区别两种不同的形式
另外重新整理了 modTopics ，把 section 换成 div 和 h3
...
//----------------------------------------------------------------------------------------------------------------------
    ...
    function createModTile($num, $dib = '', $imgWidth, $imgHeight, $lazy = true){
        ...
        for ($i = 0; $i < $num; $i++) {
            ...
            echo $src;
            echo "       </a>\n".
                "       <figcaption class=\"caption\"><a href=\"javascript:;\">标题标题标题标题标题标题标题标题标题标题标题标题标题标题标题</a></figcaption>\n".
                "    </figure>\n".
                "</div>\n";
        }
    };
    ...
    // 生成
    function createModCard($num, $dib='', $imgWidth, $imgHeight, $withTime = true, $lazy = true, $type = 1){
        for ($i = 0; $i < $num; $i++) {
    ...
    // 创建
    function addModCard($num = 1, $dib = '', $imgWidth, $imgHeight,$withTime = true, $lazy, $type = 1){
        echo "<!-- 卡片模块 这里一共输出了 ".$num." 组。 -->";
        if($dib == "dib"){
            echo "<div class=\"unit row\">";
            createModCard($num, $dib, $imgWidth, $imgHeight,$withTime, $lazy, $type);
            echo "</div>";
        }else{
            createModCard($num, $dib, $imgWidth, $imgHeight,$withTime, $lazy, $type);
        }
    ...
    //     <div class="topics topics-1"><a href="javascript:;">“2013新华年度车评选”结果正式揭晓</a></div>
    //     <div class="topics topics-2"><a href="javascript:;">新能源车步入政策年 私人市场何时破局</a></div>
    //     <div class="topics topics-3"><a href="javascript:;">政策让新能源车市场更明朗 私人购买新能源车需时间检验</a></div>
    // </div>

    // type 2
    // <div class="mod mod-topics">
    //     <h3 class="topics topics-1"><a href="javascript:;">“2013新华年度车评选”结果正式揭晓</a></h3>
    ...
    function createModTopics($num, $type){
        ...
        if($type === 'abstract'){
            echo "    <h3 class=\"topic\"><a href=\"javascript:;\">2015年国际赛事指南：世巡赛篇</a></h3>\n".
            ...
            echo "    <div class=\"topic topic-1\"><a href=\"javascript:;\">外媒观点：2014年国际公路车坛十大低潮</a></div>\n".
                 "    <div class=\"topic topic-2\"><a href=\"javascript:;\">外媒观点：2014国际公路自行车坛十大亮点</a></div>\n".
                 "    <div class=\"topic topic-3\"><a href=\"javascript:;\">郭爽获UCI场地自行车世界杯伦敦站凯林赛冠军</a></div>\n";
        };
        echo "</div>";
    };
